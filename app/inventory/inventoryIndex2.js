...
var lineItemList_v = {view: "datatable", id: "lineItemList", autoheight:true, select: true, scrollable: true, columns:
        [
...
var formItemList_v = {cols: [
        ...
        {view: "button", placeholder: "Add", width: 100, height: 25, id: "saveTheInvoiceLineButton", type: "iconButton", icon: "wxi-plus-circle"}
    ],
    id:"formItemList"
};

var reqFormEntry_v = {rows:[
...
webix.ajax().get("/labs2/php/api_methods/SELECTz.php?tableName=users&columnNames=users_manager%20AS%20value&selectColumn=users_name&selectData=" + $userId + "&dataName=data&select=1", function (text, data) {
    ...
    if ( managerLevel.search("Yes") !== -1){$$("reqManagerApproval").show();}
